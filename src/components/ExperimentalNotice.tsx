    ...
    <div className="notice-banner panel" role="status">
      ...
      <details className="notice-details">
        ...
        <p className="field-helper">
          Primer ranking, structure review, specificity review, and protocol
          suggestions remain computational aids. Independently review every
          primer, reconstructed product, and protocol before experimental use.
        </p>
      </details>
      <button
        type="button"
