...
describe('protocol calculations', () => {
  ...
  it('builds an equimolar protocol plan', () => {
    ...
    expect(plan.stageMixEntries[0].targetPmol).toBeCloseTo(0.025, 6);
    expect(plan.stageMixEntries[1].requiredMassNg).toBeCloseTo(3.3, 6);
  ...
  it('supports user-defined mix ratios', () => {
    ...
    expect(plan.stageMixEntries[0].targetPmol).toBeCloseTo(0.04, 6);
    expect(plan.stageMixEntries[1].targetPmol).toBeCloseTo(0.02, 6);
  });
